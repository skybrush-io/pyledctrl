<scene Author="dylan" Version="1.0" Dimmer="65535" Speed="-7" PhasingCourbe="0" Phasing="0" Size="0" TypeButton="1" IconTxtOver="0" Shortcut="0" ShortcutFugitif="0" Port="-1" PortFugitif="0" DontReleaseOther="1" ReleaseOther="0" FlagSlider="0" FlagWorkSlider="0">
  <Multimedia File="" SX="0" SY="0" Loop="0" TimeStart="-1" TimeEnd="-1" StopWhenOtherStart="1" />
  <EasyShow State="0" Command="0" BreakPoint="" File="" />
  <Editor EasyTimeZoom="8" EasyTimeShowIcon="1" EasyTimeCompressColorXY="1" EasyTimeShowSelected="1" EasyTimeCompress="0" EasyTimeMagnetism="1" EasyTimeMagnetismValue="100" FixturesShowBeam="1" EasyTimeModeTempo="0" EasyTimeModeTempoFade="0" EasyTimeModeTempoPulse="0" EasyTimeMesures="1" EasyTimeMesureTimer="25" />
  ...
  <EasyStep Loop="1" ModeAvanceLecture="0" AvanceLectureFade="1" NbStep="37">
    <Time Fade="0" Wait="25" />
    <Time Fade="0" Wait="25" />
    <Time Fade="0" Wait="25" />
    <Time Fade="0" Wait="25" />
